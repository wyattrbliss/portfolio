    ...
    return (
        <div className='about-content'>
            ...
            <div className='about-text'>
                ...
                My family then moved to St. Paul, MN, and I completed the rest of my pre-collegate education there.
                Once I graduated highschool, I joined Northeastern's NU.in program and studied abroad in Berlin my very first semester.
